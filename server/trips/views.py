...
class TripListCreateView(generics.ListCreateAPIView):
    ...
    send_trip_email(
        ...
        template_name="emails/trip_created.html",
        context=context
    )
...
class TripRetrieveUpdateDeleteView(generics.RetrieveUpdateDestroyAPIView):
    ...
    def perform_update(self, serializer):
        ...
        send_trip_email(
            recipient_email=trip.user.email,
            subject="Your Trip Has Been Updated",
            template_name="emails/trip_updated.html",
            context=context
        )
...
class TripStatusView(generics.GenericAPIView):
    ...
    def get(self, request, trip_id, *args, **kwargs):
        try:
            trip = Trip.objects.select_related('driver', 'user', 'pickup_location', 'dropoff_location').get(id=trip_id)
